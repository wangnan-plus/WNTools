...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UINavigationController *myResourceNav = [[UINavigationController alloc]initWithRootViewController:myResourceVC];
    
    UITabBarController *tabC = [[UITabBarController alloc]init];
    tabC.viewControllers = @[myResourceNav,uploadNav,loginNav];
